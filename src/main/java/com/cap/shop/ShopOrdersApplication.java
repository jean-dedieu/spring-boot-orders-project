...
public class ShopOrdersApplication {
	...
	public static void main(String[] args) {
		...
		order2.setOrderedCar(car10);
		// order2.se
		customerRepository.save(customer2);
		orderRepository.save(order2);
		order1.setOrderedCar(car12);
		...
		customer2.setId(3);
		customer2.setFirstName("Jean de Dieu");
		customer2.setLastName("TWAGIRUM");
		...
		for (Orders o : listOrders) {
			System.out.println(o.getId() + "\t" + o.getOrderDate() + "\t" + o.getCustomer().getFirstName() + "\t"
					+ o.getCustomer().getLastName() + "\t" + o.getCustomer().getEmailAddress() + "\t"
					+ o.getCustomer().getPassWord() + "\t" + o.getCustomer().getPaymentCardNumber());
